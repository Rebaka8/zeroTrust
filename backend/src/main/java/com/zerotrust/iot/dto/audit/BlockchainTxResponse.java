...
public class BlockchainTxResponse {
    private UUID id;
    ...
    public BlockchainTxResponse() {}

    public BlockchainTxResponse(UUID id, String txHash, String contractName, String functionName, Long blockNumber, String fromAddress, String toAddress, BigDecimal gasUsed, String status, Instant minedAt) {
        this.id = id;
        this.txHash = txHash;
    ...
    public static class Builder {
        ...
        public BlockchainTxResponse build() {
            return new BlockchainTxResponse(id, txHash, contractName, functionName, blockNumber, fromAddress, toAddress, gasUsed, status, minedAt);
        }
    }
